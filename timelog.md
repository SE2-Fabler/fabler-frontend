...
| `02-04-2024` | 7 | | | | | | Created the new book button; new book button pop up menu with prompt, genre, and any tags; long pres on books brings up context menu now; app icon and splash screen updated; sign up page created that toggles with log in page with lazy password validation |
...
| `05-04-2024` | 6 | | | | | | Worked on polishing the novel details pop up; restructured how followers, followings, bookmarks, creations get stored and how the book views would reflect the same  |
